...
<div class="wrapper">
    <div class="intro">
        <div class="profile">
            <div class="photo">
                <img src="<?= $photoMahasiswa; ?>">
            </div>
            <div class="bio">
                <h1 class="name"><?= $mahasiswa['nama']; ?></h1>
                <p class="profession"><?= $mahasiswa['keahlian']; ?></p>
                <hr />
            </div>
        </div>
        ...
        <div class="intro-section contact">
            ...
            <div class="info-section">
                <i class="fas fa-phone"></i>
                <span><?= $mahasiswa['pendidikan']; ?></span>
            </div>
        </div>
        <div class="intro-section contact">
            ...
            <div class="info-section">
                <i class="fas fa-phone"></i>
                <span><?= $mahasiswa['pengalaman']; ?></span>
            </div>
        </div>
    </div>
</div>
